...
namespace Alexa.NET.Response
{
	public static class CustomerProfilePermissions
	{
        ...
        public const string RegionAndPostalCode = "alexa:devices:all:address:country_and_postal_code:read";
        public const string FullAddress = "alexa::devices:all:address:full:read";
    }
}
